...
class SalesforceUtil{
  ...
  // Generic method to generate header for login and other oeprations
  ...
  // Generic method to generate the endpoint URL from the type of oeperation
  ...
  // to populate diff types of responses (insert, update, delete, custom rest responses etc)
